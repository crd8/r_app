        ...
        <div class="card bg-body col-12 border-0 shadow-sm mt-5">
          <div class="card-body text-body p-md-4 p-xl-5">
            <div class="d-flex justify-content-between align-items-center mb-3">
              ...
              $create_users_permission_id = $this->Permission_model->get_permission_id('user create');
              if (in_array($create_users_permission_id, $permissions)):
              ?>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      if (in_array($edit_users_permission_id, $permissions)):
                      ?>
                      ...
                      <?php
                        ...
                        if (in_array($delete_users_permission_id, $permissions)):
                      ?>
                      <a href="#" class="link-primary text-decoration-none" data-bs-toggle="modal" data-bs-target="#deleteModal" data-userid="<?php echo $user->id; ?>" data-username="<?php echo $user->username; ?>" title="Delete">
